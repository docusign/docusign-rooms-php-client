...
class TestConfig
{
    ...
    /**
      * $apiClient
      * @var DocuSign\Rooms\Client\ApiClient
      */
    protected $apiClient;
    ...
    {
        $this->host = !empty($host) ? $host : 'https://demo.rooms.docusign.com/restapi';
    ...
    /**
     * Gets apiClient
     * @return DocuSign\Rooms\Client\ApiClient
     */
    ...
    /**
     * Sets apiClient
     * @param DocuSign\Rooms\Client\ApiClient $apiClient
     * @return $this
     */
