...
use DocuSign\Rooms\Client\Auth\OAuth;
...
class ApiClient
{
    ...
    /**
     * oAuth
     *\DocuSign\Rooms\Client\ApiException
     * @var OAuth
     */
    protected $oAuth;
    ...
    public function generateAccessToken($client_id = null, $client_secret = null, $code = null)
    {
        ...
        return [$this->getSerializer()->deserialize($response, '\DocuSign\Rooms\Client\Auth\OAuthToken', $httpHeader), $statusCode, $httpHeader];
    }
    ...
    public function getUserInfo($access_token)
    {
        ...
        return [
            $this->getSerializer()->deserialize(
                $response,
                '\DocuSign\Rooms\Client\Auth\UserInfo',
                $httpHeader
            ),
            $statusCode,
            $httpHeader
