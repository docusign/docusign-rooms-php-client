...
/**
 * GetFormGroupsOptions Class Doc Comment
 *
 * @category Class
 * @package  DocuSign\Rooms
 * @author   Swagger Codegen team <apihelp@docusign.com>
...
class FormGroupsApi
{
    ...
    */
     ...
     *
     * @param ?string $account_id (Required) The globally unique identifier (GUID) for the account.
     * @param  \DocuSign\Rooms\Api\FormGroupsApi\GetFormGroupsOptions  $options for modifying the behavior of the function. (optional)
     *
     * @throws ApiException on non-2xx response
     * @return \DocuSign\Rooms\Model\FormGroupSummaryList
     */
    public function getFormGroups($account_id, \DocuSign\Rooms\Api\FormGroupsApi\GetFormGroupsOptions $options = null)
    {
     ...
     *
     * @param ?string $form_group_id The ID of the form group.
     * @param ?int $office_id The id of the office. This is the id that the system generated when you created the office.
     * @param ?string $account_id (Required) The globally unique identifier (GUID) for the account.
     *
     * @throws ApiException on non-2xx response
     * @return mixed
