...
/**
 * GetFormLibrariesOptions Class Doc Comment
 *
 * @category Class
 * @package  DocuSign\Rooms
 * @author   Swagger Codegen team <apihelp@docusign.com>
...
/**
 * GetFormLibraryFormsOptions Class Doc Comment
 *
 * @category Class
 * @package  DocuSign\Rooms
 * @author   Swagger Codegen team <apihelp@docusign.com>
...
class FormLibrariesApi
{
    ...
    */
     ...
     * @param  \DocuSign\Rooms\Api\FormLibrariesApi\GetFormLibrariesOptions  $options for modifying the behavior of the function. (optional)
     *
     * @throws ApiException on non-2xx response
     * @return \DocuSign\Rooms\Model\FormLibrarySummaryList
     */
    public function getFormLibraries($account_id, \DocuSign\Rooms\Api\FormLibrariesApi\GetFormLibrariesOptions $options = null)
    {
     ...
     * @param ?string $account_id (Required) The globally unique identifier (GUID) for the account.
     * @param  \DocuSign\Rooms\Api\FormLibrariesApi\GetFormLibraryFormsOptions  $options for modifying the behavior of the function. (optional)
     *
     * @throws ApiException on non-2xx response
     * @return \DocuSign\Rooms\Model\FormSummaryList
     */
    public function getFormLibraryForms($form_library_id, $account_id, \DocuSign\Rooms\Api\FormLibrariesApi\GetFormLibraryFormsOptions $options = null)
    {
